...
namespace ApiContabsv.DTO.DB_ContabilidadDTO
{
    public class ProveedoresDTO
    {
        ...
        [Required(ErrorMessage = "El tipo de proveedor es obligatorio de especificar")]
    ...
    public class ListProveedoresDTO
    {
        ...
        [SwaggerSchema(Description = "Descripcion del Sector")]
        public string DescripcionSector { get; set; }
        
        [SwaggerSchema(Description = "Codigo del Sector")]
